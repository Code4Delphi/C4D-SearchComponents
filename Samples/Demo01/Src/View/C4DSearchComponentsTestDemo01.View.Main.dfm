object C4DSearchComponentsTestDemo01ViewMain: TC4DSearchComponentsTestDemo01ViewMain
  ...
  object Panel4: TPanel
    ...
    object Label9: TLabel
      ...
      Width = 101
      Height = 13
      Caption = 'Acentos '#227' '#233' '#234' '#224' '#243' '#244' '#231
    end
    ...
    object lbSearch: TLabel
      ...
      Width = 150
      Height = 13
      Caption = 'Letra/palavra a ser encontrada'
    end
    object Edit1: TEdit
      Left = 16
      Top = 160
    ...
    object DBEdit2: TDBEdit
      ...
      Width = 121
      Height = 21
      DataField = 'NomeDoClienteWorkshop'
      TabOrder = 3
    end
    object GroupBox1: TGroupBox
      ...
      Caption = 'GroupBox1'
      TabOrder = 4
      object GroupBoxCondicionaisImpreObsFixa: TGroupBox
        Left = 2
        Top = 15
        Width = 238
        Height = 88
        Align = alBottom
        Caption = ' Observa'#231#227'o fixa'
        TabOrder = 0
        object DBMemoCondicionaisImpObsFixa: TDBMemo
          Left = 2
          Top = 15
          Width = 234
          Height = 71
          Align = alClient
          DataField = 'condicionais_obs_fixa'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Arial'
      ...
      object TabSheet3: TTabSheet
        ...
        object Panel9: TPanel
          ...
          object DBRadioGroup2: TDBRadioGroup
            ...
            Height = 52
            Align = alTop
            Caption = ' Composi'#231#227'o de produtos para ordem de produ'#231#227'o '
            DataField = 'producao_qtd_ou_porc'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlue
            Font.Height = -11
            Font.Name = 'Arial'
            Font.Style = [fsBold]
            Items.Strings = (
              'Trazer como padr'#227'o quantidade'
              'Trazer como padr'#227'o porcentagem')
            ParentFont = False
            TabOrder = 0
            Values.Strings = (
              'Q'
          ...
          object edtTrazer: TEdit
            Left = 40
            Top = 128
            Width = 289
            Height = 21
            TabOrder = 2
            Text = 'Nome do edit '#233' edtTrazer'
          end
        end
      end
    end
